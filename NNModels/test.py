...
database = load_database('generate/data/plane/move/database.bin')
...
mean_in, std_in, mean_out, std_out, layers = load_network('train_ris/plane/move/decompressor/decompressor.bin')
decompressor = NNModels.Decompressor.load(mean_in, std_in, mean_out, std_out, layers)

mean_in2, std_in2, mean_out2, std_out2, layers2 = load_network('train_ris/plane/move/stepper/stepper.bin')
stepper = NNModels.Stepper.load(mean_in2, std_in2, mean_out2, std_out2, layers2)

mean_in3, std_in3, mean_out3, std_out3, layers3 = load_network('train_ris/plane/move/projector/projector.bin')
