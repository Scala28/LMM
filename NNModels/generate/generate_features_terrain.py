...
print("Writing features generate/data/terrain/{0}/feature.bin ...".format(ms.settings_animation_type))
...
with open('generate/data/terrain/{0}/features.bin'.format(ms.settings_animation_type), 'wb') as f:
