...
anim_path = 'animations/{0}/plane/{1}/'.format(ms.recording_format, ms.animation_type)
...
print("Writing Database generate/data/plane/{0}/database.bin ...".format(ms.animation_type))

with open('generate/data/plane/{0}/database.bin'.format(ms.animation_type), 'wb') as f:
