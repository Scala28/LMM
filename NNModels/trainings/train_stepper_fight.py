...
if __name__ == '__main__':
    ...
    def generate_predictions():
        with torch.no_grad():
            ...
            plt.tight_layout()
            try:
                plt.savefig('./train_ris/fight/{0}/stepper/stepper_X.png'.format(ms.settings_animation_type))
            except IOError as e:
                print(e)
            ...
            try:
                plt.savefig('./train_ris/fight/{0}/stepper/stepper_Z.png'.format(ms.settings_animation_type))
            except IOError as e:
                print(e)
    ...
    for i in range(niter):
        ...
        if i % 10000 == 0:
            ...
            save_network('./train_ris/fight/{0}/stepper/stepper.bin'.format(ms.settings_animation_type), [
                stepper.layer1,
                stepper.layer2,
                stepper.predict],
                         stepper_mean_in,
            ...
            save_network_onnx(stepper,
                              stepper_mean_in,
                              './train_ris/fight/{0}/stepper/stepper.onnx'.format(ms.settings_animation_type))
