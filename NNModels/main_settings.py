...
controller_type = 'terrain'   # fight/ plane/ terrain / ...
...
settings_animations = [
    ...
    ('animations/{0}/{1}/{2}/walk1_ubisoft.{0}'.
     format(recording_format, controller_type, animation_type), 80, 3500, 'root_simple:Hips/Spine2', False, False),
    ('animations/{0}/{1}/{2}/run1_ubisoft.{0}'.
     format(recording_format, controller_type, animation_type), 90, 3500, 'root_simple:Hips/Spine2', False, False),
